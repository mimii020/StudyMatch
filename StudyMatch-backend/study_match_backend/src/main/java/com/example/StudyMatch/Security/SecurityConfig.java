        ...
        http
                ...
                .authorizeHttpRequests(
                        req -> req
                                ...
                                .requestMatchers(HttpMethod.POST,"/help-requests/**").hasRole("STUDENT")
                                .requestMatchers(HttpMethod.PATCH,"/help-requests/**").hasRole("STUDENT")
                                .requestMatchers(HttpMethod.GET,"/help-requests/**").hasRole("STUDENT")
